# Intorduction
This Coodbook explains the codes that were used in run-analysis.r. The purpos of this R code is to  tidy up data that was colleced from an experiment 
...
# The initial dataset contained the following files.
