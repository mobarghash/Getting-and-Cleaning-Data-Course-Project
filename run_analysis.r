## This program merges data from a number of .txt files and produce clean data ready for analysis
## The data is downloaded from https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip website 
## the data was collected from the accelerometers of Samsung Galaxy S smartphone. 
...
## Ansewring the first requirment  
## First, read all required .txt files and label the datasets and 
